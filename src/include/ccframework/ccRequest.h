...
namespace ccFramework {
    ...
    public:
        ...
        ccArray getRequestParameterAsArray(std::string name, ccArray default_value = ccArray());
        ccArray getPostParameterAsArray(std::string name, ccArray default_value = ccArray());
        ccArray getRequestParamters();
        ccArray getPostParamters();
